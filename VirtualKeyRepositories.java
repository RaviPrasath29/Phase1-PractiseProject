...
public class VirtualKeyRepositories {
 ...
 String title = " Welcome to Virtual Key Repository \n";
 Scanner head = new Scanner(title);
 VirtualKeyRepositories mc = new VirtualKeyRepositories();
 ...
 switch (num) {
 case 0:
 System.out.println("Opeartion End");
 System.exit(1);
 break;
 case 1:
 ...
 System.out.println("4. Any other to re-do the process");
...
class Operations {
	...
	public static void searchFile() {
		...
		if (file.exists()) {
			...
			System.out.println("Sorry, Couldn't found");
		}
		PrintWriter pw;
		try {
	...
	public static void listFiles() {
		int fileCount = 0;
		String list_Prompt = "Listing files.... ";
		ArrayList<String> filenames = new ArrayList<String>();
		File directoryPath = new File(System.getProperty("user.dir"));
		File[] listOfFiles = directoryPath.listFiles();
		fileCount = listOfFiles.length;
		System.out.println("");
		VirtualKeyRepositories.printBox(new Scanner(list_Prompt), list_Prompt.length());
		System.out.println("");
